<template>
  <el-container class="app-container" :class="{
    ...
    <r-loading type="bars" color="#5ac1dd"></r-loading>
    <el-aside class="app-side" :width="hideSide ? '0' : sideWidth + 'px'" :style="{background: theme.theme.backgroundColor}">
      <div class="app-header-logo-box" :style="{height: headerHeight + 'px', color: theme.theme.activeTextColor}">
        ...
        <span class="header-logo-text">Guard</span>
      </div>
...
import AppSide from '@/components/common/app-side'
export default {
  name: 'app-view',
  data() {
    return {
