  ...
  <div class="page-body">
    ...
    <m-box>
      ...
      <div class="priview-box" style="width: 720px; margin: 0 auto;">
        <h1>Keyboard 虚拟键盘</h1>
        <p class="description">本页面代码可以在
          <a href="https://github.com/mengdu/vue-element-admin-tpl/blob/master/src/pages/c-keyboard.vue">
            <code>src/pages/c-keyboard.vue</code>
          </a>找到。</p>
        ...
        <h2>中/英文键盘</h2>
        <el-popover ref="pykb" placement="bottom" width="730" trigger="click">
...
<script>
import MPyKeyboard from '@/components/model/keyboard/py-keyboard'
export default {
